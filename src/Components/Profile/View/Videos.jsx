...
import { FaPlay, FaCalendarAlt, FaWater, FaAnchor } from 'react-icons/fa';

const Videos = () => {
  const videos = [
    {
      id: 1,
      title: "Ocean Tech Conference Talk",
      description: "My talk at the Ocean Tech Conference 2023 about modern JavaScript frameworks and ocean conservation.",
      date: "June 15, 2023",
      thumbnail: "https://images.unsplash.com/photo-1557804506-669a67965ba0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=80",
      duration: "45:20"
    },
    {
      id: 2,
      title: "Deep Sea React Performance",
      description: "Workshop on optimizing React applications for better performance with ocean-themed examples.",
      date: "April 22, 2023",
    ...
    {
      id: 3,
      title: "Full Stack Ocean Development",
      description: "A comprehensive masterclass covering both frontend and backend development with ocean-inspired projects.",
      date: "March 10, 2023",
  ...
  return (
    <section id="videos" className="py-20 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900 dark:to-cyan-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <p className="text-center max-w-2xl mx-auto mb-12 text-cyan-700 dark:text-cyan-300 font-poppins">
          Explore my collection of conference talks, workshops, and tutorials on various web development topics.
        </p>
            ...
            >
              <div className="relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-16 h-16 rounded-full bg-gradient-to-r from-blue-500 to-cyan-600 flex items-center justify-center opacity-90 hover:opacity-100 transition-opacity cursor-pointer">
